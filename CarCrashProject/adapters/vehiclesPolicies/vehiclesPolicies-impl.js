...
var addStatement = WL.Server.createSQLStatement(" insert into InsurancePolicies(Email,PolicyNumber,ExpirationDate,IDInsuranceCompany,Identifier) values(?,?,?,?,?)" +
		" insert into Vehicle (Plates,Serie,IDVehicleType,IDVehicleBrand,Model,Year,Color,PictureURL,OwnerName,Cellphone, Email, Identifier) values ( ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?)"
		);
var updateStatement = WL.Server.createSQLStatement("update Vehicle set  Plates=?,Serie=?, IDVehicleType=?, IDVehicleBrand=?, Model=?, Year=?,Color=?,PictureURL=?,OwnerName=?,Cellphone=? where identifier=? and email=?" +
...
function save(pVehiclesPolicies){
	return WL.Server.invokeSQLStatement({
		...
		parameters : [ pVehiclesPolicies.email,  
			              ...
			              pVehiclesPolicies.Plates,pVehiclesPolicies.Serie,'1','1',pVehiclesPolicies.Mark,pVehiclesPolicies.Model,pVehiclesPolicies.Color,
...
function update(pVehiclesPolicies){
	...
	return WL.Server.invokeSQLStatement({
		...
		parameters : [ pVehiclesPolicies.Plates,pVehiclesPolicies.Serie,'1','1',pVehiclesPolicies.Mark,pVehiclesPolicies.Model,pVehiclesPolicies.Color,pVehiclesPolicies.carPicture,
